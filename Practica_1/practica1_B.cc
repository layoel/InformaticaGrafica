...
//para cambiar el modo de visualización y la figura que se muestra
int modo = 0;
int figura = 0;
...
void draw_objects()
{
     if (figura == 1)
        switch(modo){
            case 0:
                piramide.draw_puntos(0.0,0.0,0.0,3);
            break;
            case 1:
                piramide.draw_aristas(1.0,0.5,0.0,3.0);
            break;
            case 2:
                piramide.draw_solido(1.0,0.5,0.0);
            break;
            case 3:
                piramide.draw_solido_ajedrez(0.7,0.0,0.7, 0.0,0.1,0.9);
            break;
        }
     ...
     if (figura == 2)
        switch(modo){
            case 0:
                cubo.draw_puntos(0.0,0.0,0.0,3);
            break;
            case 1:
                cubo.draw_aristas(1.0,0.5,0.0,3.0);
            break;
            case 2:
