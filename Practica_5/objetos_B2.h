...
typedef enum{POINTS,EDGES,SOLID_CHESS,SOLID,SELEC,CARA,SELEC_CARA} _modo;
...
void	draw_seleccion_color(float r1, float g1, float b1);
void	draw_cara(float r1, float g1, float b1, float r2, float g2, float b2,  int numCara);
void 	draw_seleccion_color_cara(float r1, float g1, float b1, float r2, float g2,float b2, int numCara);
