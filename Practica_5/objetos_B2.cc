...
void  _triangulos3D::draw_seleccion_color(float r1, float g1, float b1){
...
void  _triangulos3D::draw_cara(float r1, float g1, float b1, float r2, float g2, float b2, int numCara){

  glPolygonMode(GL_FRONT_AND_BACK,GL_FILL);
  glColor3f(r1,g1,b1);
  glBegin(GL_TRIANGLES);
    glVertex3fv((GLfloat *) &vertices[caras[numCara]._0]);
    glVertex3fv((GLfloat *) &vertices[caras[numCara]._1]);
    glVertex3fv((GLfloat *) &vertices[caras[numCara]._2]);
  glEnd();


}

void  _triangulos3D::draw_seleccion_color_cara(float r1, float g1, float b1, float r2, float g2, float b2, int numCara){
...
switch (modo){
  ...
  case SELEC:draw_seleccion_color(r1, g1, b1);break;
  case CARA:draw_cara(r1, g1, b1, r2, g2, b2, grosor);break;
  case SELEC_CARA:draw_seleccion_color_cara(r1, g1, b1, r2, g2, b2, grosor);break;
	}
}
